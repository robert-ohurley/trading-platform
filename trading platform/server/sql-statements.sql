...
('Thunder NFT', 'A powerful piece showcasing the raw and unforgiving force of nature, encapsulated in a moment.', 0.432, 'Digital art', '/nft4.png'),
('Digital Unicorns', 'A mesmerizing journey to a mythical realm where digital unicorns roam freely.', 0.25, 'Digital art', '/nft5.png'),
('Secret Stones', 'Mystical stones with secretive inscriptions, offering a glimpse into ancient knowledge.', 0.678, 'Digital art', '/nft6.png'),
...
('Reflected Light', 'A surreal exploration of light and its reflections, creating a harmonious balance between reality and illusion.', 0.512, 'Utility', '/nft9.png'),
('Spells of Genesis', 'A spellbinding voyage to the creation, symbolizing the genesis of life and the universe.', 0.035, 'Utility', '/nft10.png'),
('Dose of Art', 'A daily dose of artistry and imagination, enriching your life with a splash of colors and emotions.', 0.087, 'Utility', '/nft11.png'),
('Futuristic Realism', 'Depicts speculative futures imbued with a sense of realism, sparking curiosity and wonder.', 0.797, 'Utility', '/nft12.png'),
...
('Crypto Potato', 'Embrace the whimsical world of cryptocurrencies with this fun and lighthearted piece.', 0.315, 'Profile pictures', '/nft16.png'),
('Nova Auroras', 'Explore the ethereal beauty of the auroras, witnessing the universe’s artistry in its purest form.', 0.321, 'Profile pictures', '/nft17.png'),
