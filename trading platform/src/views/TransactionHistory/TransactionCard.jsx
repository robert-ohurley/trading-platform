                ...
                <div className="flex flex-row w-50rem justify-between items-center">
                    ...
                    <div className="flex flex-row items-center justify-center ">
                        ...
                        <div className="flex flex-col ml-5">
                            <p className="text-lg font-bold">{transaction.nftName}</p>
                            <p className="text-sm text-gray-500 ">Transfer to {transaction.to}</p>
                        </div>
                    </div>
                    <div className="flex flex-row items-center">
                        <p className="font-medium text-sm text-gray-700">{transaction.ethValue} eth</p>
                    </div>
                </div>
            </div>
