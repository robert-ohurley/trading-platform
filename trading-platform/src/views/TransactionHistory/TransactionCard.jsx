...
function TransactionCard({ transaction, idx }) {
  ...
  return (
    <div className={"h-24 overflow-hidden flex items-center justify-center  hover:-translate-y-1 hover:scale-105 duration-200 hover:cursor-pointer hover:bg-slate-200 " + bgColor}>
